...
import {
  ...
  PostGrade,
  DeleteGrade,
} from "../../../services/userGrades/uses-grades-service";
...
const AdminGradesTable = () => {
  ...
  const { themeColor, setThemeColor, purpleMode, setPurpleMode } =
  ...
  return (
    <>
      {loading ? (
        <Stack
          sx={{ color: "grey.500", marginLeft: "50vw", marginTop: "30vh" }}
          spacing={2}
          direction="row"
        >
        ...
        >
          <input
            style={purpleMode ? themeColor.purpleSelect : themeColor.cyanSelect}
          ...
          <input
            ...
            name="test"
            onChange={updateValue}
            placeholder="Enter Student test"
          />
 ...
 <option>Test</option>
   {
     tests?.map((test , index) => 
          ...
          <select
            onChange={(event) => {
              handleGradesSorting(event);
            }}
            className="table-select"
          >
            <option name="Sort" value="">
              {" "}
              Sort{" "}
            </option>
          ...
          <button
            style={purpleMode ? themeColor.purpleButton : themeColor.cyanButton}
            ...
            <thead>
              <tr>
                <th
                  ...
                  style={
                    purpleMode
                      ? themeColor.lightPurpleTheme
                      : themeColor.lightCyanTheme
                  }
                >
                  Name
                </th>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <UpdateIcon
                      ...
                      onClick={() => updateUser(user, userToUpdate)}
                    />{" "}
                    <DeleteIcon
                      className="admin-Buttons"
                      onClick={() => deleteUserGrade(user)}
                    />
                  </td>
                </tr>
              ))}
